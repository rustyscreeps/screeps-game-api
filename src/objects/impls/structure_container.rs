use crate::{
    objects::{RoomObject, Structure, Store},
};
...
extern "C" {
    ...
    /// The [`Store`] of the container, which contains information about what resources it is it holding.
    ///
    /// [Screeps documentation](https://docs.screeps.com/api/#StructureContainer.store)
    #[wasm_bindgen(method, getter)]
    pub fn store(this: &StructureContainer) -> Store;

    /// The number of ticks until the rampart will decay, losing TODO CONSTANT hits.
    ///
