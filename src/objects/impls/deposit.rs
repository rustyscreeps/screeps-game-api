...
extern "C" {
    ...
    /// Object ID of the deposit, which can be used to efficiently fetch a fresh reference to the object on subsequent ticks.
    ///
    ...
    /// The number of ticks until this deposit disappears, which is reset if it is harvested.
    ///
