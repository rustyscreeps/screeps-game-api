...
extern "C" {
    ...
    /// Amount of energy this source will regenerate to after [`Source::ticks_to_regeneration`] reaches 0.
    ///
    ...
    /// [`SOURCE_ENERGY_NEUTRAL_CAPACITY`]: crate::constants::SOURCE_ENERGY_NEUTRAL_CAPACITY
    /// [`SOURCE_ENERGY_KEEPER_CAPACITY`]: crate::constants::SOURCE_ENERGY_KEEPER_CAPACITY
    #[wasm_bindgen(method, getter = energyCapacity)]
    pub fn energy_capacity(this: &Source) -> u32;
    
    /// Object ID of the source, which can be used to efficiently fetch a fresh reference to the object on subsequent ticks.
    ///
    /// [Screeps documentation](https://docs.screeps.com/api/#Source.id)
    #[wasm_bindgen(method, getter)]
    pub fn id(this: &Source) -> JsString;

    /// The number of ticks until this source regenerates to its [`Source::energy_capacity`], or 0 if the timer has not started yet.
    ///
