...
pub mod structure {
    pub use super::{
        numbers::{
            extension_energy_capacity, rampart_hits_max, CONSTRUCTION_COST_ROAD_SWAMP_RATIO,
            ...
            EXTRACTOR_COOLDOWN, EXTRACTOR_HITS, LAB_ENERGY_CAPACITY, LAB_HITS,
            ...
            ROAD_WEAROUT_POWER_CREEP, SPAWN_ENERGY_CAPACITY, SPAWN_HITS, STORAGE_CAPACITY,
            STORAGE_HITS, TERMINAL_CAPACITY, TERMINAL_HITS, TERMINAL_SEND_COST, TOWER_CAPACITY,
            TOWER_HITS, WALL_HITS, WALL_HITS_MAX,
        },
        types::StructureType,
    };
}
